function Button({ type, onClick, value, children }) {
  const styles = {
    ...
    secondary:
      "md:px-3 px-1  py-1 md:py-2 text-xs md:text-lg  border hover:translate-y-1  duration-300  rounded-md hover:rounded-lg border-sky-200 hover:border-sky-300 uppercase font-semibold text-sky-200/50",
    normal:
